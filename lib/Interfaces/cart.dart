                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [const Text("SUBTOTAL :",style: TextStyle(fontSize: 18),), Text("$price TND",style: const TextStyle(fontSize: 14),)],
                    ),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [Text("DELIVERY FEE :",style: TextStyle(fontSize: 18),), Text("3 TND",style: TextStyle(fontSize: 14),)]),
                    Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("${price + 3} TND",style: const TextStyle(fontSize: 14)),
                          TextButton(
            style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(const Color(0xffbd2005)),
                fixedSize: MaterialStateProperty.all(const Size(250, 43)),
                shape: MaterialStateProperty.all(const RoundedRectangleBorder(
                  borderRadius: BorderRadius.all(Radius.circular(10)),
                ))),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) =>Checkout(price: price,)));
            },
            child: const Text(
              "GO TO CHECKOUT",
